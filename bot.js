...
Вітаю, ${firstName}!
Системний термінал аналітичного компаньйона успішно активовано.

📊 **Параметри системи:**
STORKCRYPTO — це професійний Web3-інструмент та помічник трейдера для відстеження ринкових даних у реальному часі. Тут ви отримуватимете екстрені сповіщення про різку волатильність ринку (> 0.5%) та зможете випробовувати складні торгові стратегії.

⚠️ **Правовий статус та застереження:**
• Даний інструмент є виключно аналітичним помічником та **НЕ** надає фінансових чи інвестиційних порад.
• Поточні торгові тренування здійснюються у віртуальному демо-середовищі без ризику реальних грошей.
• У майбутніх релізах заплановано Web3-інтеграцію для підключення реальних криптогаманців.
• Всі майбутні транзакції з реальними активами (після їх підключення) проводяться виключно за вашої особистої ініціативи та під вашу власну відповідальність. Сервіс не несе жодної відповідальності за фінансові результати або збереження активів.

⚡ **Доступні команди:**
/status - Перевірити стан системи
/price - Миттєво отримати ціну BTC
        `;
