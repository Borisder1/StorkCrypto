            ...
            <div className="relative z-10 flex flex-col items-center gap-3">
                ...
                <div>
                    ...
                    <div className="flex flex-col gap-1 text-[10px] text-slate-400 font-mono">
                        <p>{t('locked.requires')} <span className="text-white font-bold">{t('locked.level')} {minLevel}</span></p>
                        <p className="opacity-50">{t('locked.or')}</p>
                    </div>
                </div>
                ...
                >
                    <ZapIcon className="w-3 h-3" /> {t('locked.get_instant_access')}
                </button>
            </div>
        </div>
    );
