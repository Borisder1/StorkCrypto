                ...
                <div className="flex-1 overflow-y-auto p-6 custom-scrollbar overscroll-contain pb-12">
                                ...
                                <div key={p.id} className={`border ${p.id === 'WHALE' ? 'border-brand-purple/40 bg-brand-purple/5' : 'border-brand-cyan/40 bg-brand-cyan/5'} rounded-3xl p-6 relative active:scale-[0.98] transition-transform group overflow-hidden`}>
                                    ...
                                    <div className="flex justify-between items-start mb-4 relative z-10">
                                        <div>
                                            ...
                                            <p className="text-[10px] text-slate-500 font-mono uppercase">{t('sub.full_access')}</p>
                                        </div>
                    ...
                    {step === 'REDIRECT' && (
                        <div className="py-20 text-center animate-pulse">
                            ...
                            <h3 className="text-white font-black font-orbitron uppercase tracking-widest">{t('sub.awaiting_ui')}</h3>
                        </div>
                    )}
                    ...
                    {step === 'VERIFY' && (
                        <div className="py-16 text-center animate-zoom-in">
                            ...
                            <h3 className="text-xl font-black text-white font-orbitron uppercase">{t('sub.link_established')}</h3>
                            <p className="text-slate-500 text-xs mt-2 font-mono uppercase">{txHash}</p>
                            <button onClick={onClose} className="mt-8 px-8 py-3 bg-white/5 border border-white/10 rounded-xl text-[10px] font-black uppercase text-white">{t('sub.back_terminal')}</button>
                        </div>
                    )}
                </div>
            </div>
