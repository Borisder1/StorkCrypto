...
export const TacticalBackground: React.FC = memo(() => {
    const dataSaver = useStore(state => state.settings.dataSaver);
    ...
    return (
        <div className="fixed inset-0 pointer-events-none overflow-hidden z-0 bg-[#0A0A2A] will-change-transform">
            ...
            <div className="absolute inset-0 perspective-[800px] opacity-20">
