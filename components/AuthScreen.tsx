...
const AuthScreen: React.FC = () => {
    ...
    return (
        <div className="fixed inset-0 z-[100] bg-[#020617] flex flex-col overflow-hidden h-[100dvh] w-full">
            ...
            {/* Email Login Modal (Hidden by default, accessed via secret tap) */}
            {isAdminMode && (
                    ...
                    <div className="bg-brand-card border border-white/10 rounded-3xl p-6 w-full max-w-sm shadow-2xl animate-zoom-in">
                        <div className="flex justify-between items-center mb-6">
                            <div className="flex items-center gap-3">
                                ...
                                <h2 className="text-white font-black uppercase tracking-widest font-orbitron">Email Access</h2>
                            </div>
                        ...
                        <div className="space-y-4 mb-6">
                            <div>
                                ...
                                <input 
                                    ...
                                    placeholder="pilot@storkcrypto.com"
                                />
                            </div>
                            <div>
