        ...
        if (this.state.hasError) {
            return (
                <div className="fixed inset-0 z-[999] flex flex-col items-center justify-center p-6 text-center bg-[#020617] text-white overflow-hidden">
                    ...
                    <div className="relative z-10 w-full max-w-sm bg-black/80 backdrop-blur-xl border border-red-500/30 rounded-[2rem] p-8 shadow-[0_0_50px_rgba(239,68,68,0.2)] animate-pulse">
