...
import { ShieldIcon, ChevronRightIcon, ActivityIcon, FileTextIcon, LinkIcon, BarChartIcon, BotIcon, ZapIcon, GlobeIcon, MoonIcon, StorkIcon, UserIcon } from '../icons';
...
const StatItem: React.FC<{ label: string; value: string; sub: string; color: string }> = ({ label, value, sub, color }) => (
    <div className="bg-brand-card/40 backdrop-blur-xl shadow-inner border border-white/5 rounded-3xl p-4 flex flex-col items-center justify-center text-center h-28 interactive-card">
                        ...
                        <div className="relative z-10 p-4 sm:p-6 flex flex-col items-center">
                            ...
                            >
                                ...
                                <div className="text-left">
                                    <span className="block text-[8px] font-black text-slate-400 uppercase tracking-wide">{t('profile.exchange')}</span>
