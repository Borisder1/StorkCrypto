...
export const ArrowUpRightIcon: React.FC<{className?: string}> = ({className}) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M7 17V7h10"/><path d="m7 7 10 10"/></svg>
);

export const StorkIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M16 6.56c0-2.05-1.1-3.56-3.33-3.56-1.45 0-2.48.8-2.67 1.76"/>
        <path d="M16 6.56c0 1.38-1.12 3.34-3.33 3.34-1.25 0-2.25-.6-2.67-1.45"/>
        <path d="m13.21 12.53.53 1.25c.18.42.6.72 1.07.72h.43c.46 0 .86-.29.98-.72l.53-1.84c.12-.42.53-.72.99-.72h.43c.47 0 .87.29.98.72l.53 1.25"/>
        <path d="M10 16.5a2.5 2.5 0 0 1-5 0"/>
        <path d="M16 16.5a2.5 2.5 0 0 1-5 0"/>
        <path d="M12.91 9.92c.31-1.34 1.31-2.21 2.42-2.21 1.06 0 2.07.78 2.42 2.21"/>
        <path d="M11.25 21.75c-1.25-1-2-2.5-2-4.5"/>
        <path d="M14.75 21.75c1.25-1 2-2.5 2-4.5"/>
    </svg>
);
...
export const PickaxeIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M14.5 2L2 14.5l2.5 2.5 12.5-12.5z" />
        <path d="M14 8l-2 2" />
        <path d="M22 2l-7.5 7.5" />
        <path d="M17 12l2.5 2.5" />
        <path d="M12 17l-7.5 7.5L2 22l2.5-2.5" />
    </svg>
);
...
export const TelegramIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm4.64 6.8c-.15 1.58-.8 5.42-1.13 7.19-.14.75-.42 1-.68 1.03-.58.05-1.02-.38-1.58-.75-.88-.58-1.48-1.02-2.4-1.63-1.06-.7-.37-1.09.23-1.72.15-.16 2.8-2.56 2.85-2.78.01-.03.01-.13-.05-.18s-.15-.07-.22-.04c-.09.02-1.54.98-4.36 2.88-.41.28-.79.42-1.12.41-.37-.01-1.08-.21-1.6-.37-.64-.2-1.15-.31-1.1-.64.03-.17.25-.34.69-.52 2.7-1.17 4.5-1.95 5.39-2.32 2.56-1.06 3.09-1.25 3.44-1.25.08 0 .25.02.36.08.11.06.19.16.22.25.03.11.05.3.05.41z"/>
    </svg>
);
...
export const WalletIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M19 7V4a1 1 0 0 0-1-1H5a2 2 0 0 0 0 4h15a1 1 0 0 1 1 1v4h-3a2 2 0 0 0 0 4h3v4a1 1 0 0 1-1 1H5a2 2 0 0 1-2-2V7"/><path d="M18 11h.01"/></svg>
);

export const SettingsIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.74l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.38a2 2 0 0 0-.73-2.73l-.15-.08a2 2 0 0 1-1-1.74v-.5a2 2 0 0 1 1-1.74l.15-.09a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z"/><circle cx="12" cy="12" r="3"/></svg>
);
