                    ...
                    <div className="space-y-8">
                        ...
                        <div className="border border-white/10 p-6 rounded-xl bg-black/40">
                            ...
                            <div className="mt-4 space-y-2">
                                {(Array.isArray(partnerTasks) ? partnerTasks : []).map(t => (
                        ...
                        <div className="border border-white/10 p-6 rounded-xl bg-black/40">
                            ...
                            <div className="mt-4 space-y-2">
                                {(Array.isArray(activeBanners) ? activeBanners : []).map(b => (
                ...
                {activeTab === 'APPROVALS' && (
                    <div className="space-y-4">
                        ...
                        {(!settings?.pendingSubRequests || settings.pendingSubRequests.length === 0) ? (
                            ...
                            (Array.isArray(settings?.pendingSubRequests) ? settings.pendingSubRequests : []).map(req => (
